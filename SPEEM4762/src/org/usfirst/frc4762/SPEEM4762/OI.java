...
public class OI {
    ...
    public JoystickButton joystickButtonUp;
    public JoystickButton joystickButtonDown;
    public Joystick driveJoystick;
	public JoystickButton joystickButtonDriveBoost;
    ...
    public OI() {
        ...
        // joystickButtonUp = new JoystickButton(driveJoystick, 9);
        //joystickButtonUp.whileHeld(new LiftUp());
        
        joystickButtonDriveBoost = new JoystickButton(driveJoystick, 9);
        joystickButtonDriveBoost.whileHeld(new Boost_de_boost());
        
        //joystickButtonDriveBoost = new JoystickButton(driveJoystick, 1);
        //joystickButtonDriveBoost.whileHeld(new CubeInjector());
